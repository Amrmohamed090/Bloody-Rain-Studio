...
ALLOWED_HOSTS = ["13.49.209.165","127.0.0.1", "portifolio-server-21uj.onrender.com","bloody-rain.onrender.com","bloodyrainstudio.com", "www.bloodyrainstudios.com"]
...
DATABASES = {
    'default': dj_database_url.config(       
         ...
         default=f"postgresql://bloodyrain:Team_BloodyRain111@localhost:5432/portifolio_db",        
         conn_max_age=600    )
         }
